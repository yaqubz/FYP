# Testing 24 Jan (Source: https://tello.oneoffcoder.com/swarm.html) - cannot work with Deco?
# Alternatively can just send directly via Packet Sender (see User Manual)

"""
Run in terminal:
python set_apmode.py -s [SSID] -p [PASSWORD]
"""
